  ...
  return new Promise(function (resolve, reject) {
    fs.readFile(filePath, {encoding: 'utf-8'}, function (err, data) {
      ...
      try {
        ...
        info(log, __('Узел навигации портала %code будет записан в БД.', {code: n.code}));
  ...
  return new Promise(function (resolve, reject) {
    ...
    fs.access(d, fs.R_OK, function (err) {
      if (!err) {
        ...
        warn(log, __('Не удалось прочитать директорию меты навигации модуля портала %src', {src}));
        resolve();
      }
    });
  });
  ...
  return new Promise(function (resolve, reject) {
    di(
      ...
      function (scope) {
        ...
        info(scope.sysLog, __('Импорт меты модуля портала из %pth', {pth}));
